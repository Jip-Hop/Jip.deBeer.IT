...
Due to the COVID-19 pandemic, many activities (which would ordinarily be performed physically) are now done behind the computer, with a mouse cursor. Grocery shopping for example, is one of those things for me. The corresponding Mouse Trials made the selection.
...
{% include figure image_path="2020/10/11/stream_of_trials_-_jip_de_beer_cutting_grass.jpg" caption="Cutting the grass" alt="" class="" max_width=2880 max_height=3840%}
